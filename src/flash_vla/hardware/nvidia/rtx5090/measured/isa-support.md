...
This is deliberately stronger evidence than the PTX ISA manual's *Target ISA
Notes*: ptxas is the implementation the project actually compiles through, and
its refusals quote the target verbatim. The manual
([PTX ISA](https://docs.nvidia.com/cuda/parallel-thread-execution/)) states the
same contract and is the right citation for *why*; it is a single ~5 MB page, so
the per-instruction notes were not machine-extracted for this file.
...
```
instruction                         sm_90a   sm_120  sm_120a
------------------------------------------------------------
[tma]
tma.load.2d                            yes      yes      yes
tma.load.3d                            yes      yes      yes
tma.load.2d.multicast                  yes      yes      yes
tma.store.2d                           yes      yes      yes
tma.store.3d                           yes      yes      yes
tma.prefetch.2d                        yes      yes      yes
tma.tensormap.prefetch                 yes      yes      yes
tma.bulk.load.raw                      yes      yes      yes
tma.bulk.store.raw                     yes      yes      yes
tma.commit_group                       yes      yes      yes
tma.wait_group                         yes      yes      yes
tma.wait_group.read                    yes      yes      yes
[cpasync]
cpasync.cg.16                          yes      yes      yes
cpasync.commit_group                   yes      yes      yes
cpasync.wait_group                     yes      yes      yes
[mbarrier]
mbarrier.init                          yes      yes      yes
mbarrier.arrive.expect_tx              yes      yes      yes
mbarrier.try_wait.parity               yes      yes      yes
mbarrier.expect_tx.cluster             yes      yes      yes
[wgmma]
wgmma.fence                            yes       no       no
wgmma.commit_group                     yes       no       no
wgmma.wait_group                       yes       no       no
wgmma.mma_async.bf16.n64               yes       no       no
wgmma.mma_async.fp8.n64                yes       no       no
[mma]
mma.m16n8k16.bf16                      yes      yes      yes
mma.m16n8k16.f16                       yes      yes      yes
mma.m16n8k8.tf32                       yes      yes      yes
mma.m16n8k32.fp8                       yes      yes      yes
mma.m16n8k32.blockscale.mxf8f6f4        no       no      yes
mma.m16n8k64.blockscale.mxf4            no       no      yes
[ldst_matrix]
ldmatrix.x4.b16                        yes      yes      yes
ldmatrix.x4.trans.b16                  yes      yes      yes
stmatrix.x4.b16                        yes      yes      yes
ldmatrix.m16n16.trans.b8                no       no      yes
[cluster]
cluster.mapa                           yes      yes      yes
cluster.barrier.arrive                 yes      yes      yes
cluster.barrier.wait                   yes      yes      yes
cluster.ctarank                        yes      yes      yes
cluster.nctarank                       yes      yes      yes
[warpspec]
setmaxnreg.inc                         yes       no      yes
setmaxnreg.dec                         yes       no      yes
elect.sync                             yes      yes      yes
[tcgen05]
tcgen05.alloc                           no       no       no
tcgen05.ld                              no       no       no
[misc]
pdl.griddepcontrol.wait                yes      yes      yes
pdl.griddepcontrol.launch              yes      yes      yes
red.global.add.v4.f32                  yes      yes      yes
red.release.gpu.add.u32                yes      yes      yes
fence.proxy.async.shared               yes      yes      yes
fence.proxy.async.global               yes      yes      yes
shfl.sync.bfly                         yes      yes      yes
```
...
**Still unverified, and load-bearing if a port reaches for it:** TMA
`.multicast::cluster` assembles for `sm_120`, but no runtime test here issues one.
Assembling proved nothing for clusters until they were launched, and it proves
nothing here either. Treat multicast as unknown until a probe issues one and
checks the delivered bytes.
