"""Take the expert's gated activation into the packed gate/up GEMM's epilogue."""
...
def make_wrappers(scratch, selected_names=None):
    return _make_wrappers(scratch, selected_names, cache_rope_frequency=True,
                          ...
                          fused_prefix_pointwise=True, skinny_gemm=True,
                          split_attention=True, fused_vision_attention=True,
                          fused_gate=True)
