...
STANDARD: tuple[OpSpec, ...] = (
    ...
    OpSpec("vision_encoder_norm_qkv",
           ...
           outputs=("out", "x_norm"), weights=("norm_w", "norm_b", "qkv_w", "qkv_b"),
           aux=("x_norm",), flops=gemm("x", "qkv_w")),
    ...
    OpSpec("vision_encoder_norm_ffn_up",
           ...
           outputs=("out", "x_norm"), weights=("norm_w", "norm_b", "weight", "bias"),
           aux=("x_norm",), flops=gemm("x", "weight")),
