...
```bash
.venv/bin/python .claude/skills/kernel-wiki/scripts/validate.py
```
...
```bash
.venv/bin/python .claude/skills/kernel-wiki/scripts/pin_artifacts.py artifacts/kernels/sm90-templates/variants
```
