...
Contrast with `flashmla-sm90.md`, whose warp groups cooperate rather than
...
checks:
  ...
  residency: >
    ...
    CTA. That argument fails at small M -- see flashmla-sm90.md. -> PASS.
...
`flashmla-sm90.md`, where this section carries the algorithm.
...
and the same reasoning inverts at small M — see `flashmla-sm90.md`.
