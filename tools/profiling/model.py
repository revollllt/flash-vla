"""Per-call-site time inside the captured graphs of any Target.
    ...
    python -m tools.profiling.model --target h100/pi05 --overview --trace-dir artifacts/profile
    python -m tools.profiling.model --target h100/pi05 --segment action_expert
    python -m tools.profiling.model --target h100/pi05 --plan reference --plan shipped   # A/B
    python -m tools.profiling.model --target h100/pi0 --plan reference --trace-dir artifacts/profile
