...
| G6 | full re-profile at final HEAD on ACD1-33; wall min <= 14.5 ms; `profiles/pi05/latency-breakdown.md` rewritten | e2e/profile/traces JSON; layer_breakdown sequence assert | document rewritten from job 591097 (HEAD af02950, ACD1-33): wall 16.073, vision 2.012 / prefix 6.154 / decoder 7.474; sequence asserts pass on both stages. The <= 14.5 ms half is NOT met and the identified queue is exhausted |
