...
- Phase: P0-C transition core implemented and CPU/renderer-verified. Next: establish verifiable clock-policy provenance and connect production report/request adapters, then run real compatible checkpoint transfer; Campaign Registry in P0-D follows. Real checkpoint A/B availability remains unresolved, and independent registry work can proceed while assets are resolved.
