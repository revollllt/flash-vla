...
# Usage:
#   PROFILE_KIND=nsys PROFILE_OUT=profiles/ffn/nsys_%j sbatch lab/sbatch/profile_ffn.sh
#   PROFILE_KIND=ncu  PROFILE_OUT=profiles/ffn/ncu_%j  sbatch lab/sbatch/profile_ffn.sh
#
...
PY_ARGS=(lab/pi05/ffn_taskloop.py
