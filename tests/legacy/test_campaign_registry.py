...
from tests.legacy.test_weight_dependency import workspace, candidate, finalize
...
def test_fork_after_transition_has_independent_execution_checkout(setup):
    from tests.legacy.test_context_transition import request, next_spec
...
def test_child_transition_uses_its_new_checkout_after_fork(setup):
    from tests.legacy.test_context_transition import request
...
import sys
from pathlib import Path
from tests.legacy.test_weight_dependency import finalize
...
from lab.optimize import campaign, store
from lab.optimize.registry import CampaignRegistry
from tests.legacy.test_weight_dependency import candidate, finalize
