...
from tests.legacy.test_target_onboarding import (
    spec as legacy_spec, official_reference, inventory, target_bring_up, ladder, floor_profile)
from tests.legacy.test_weight_dependency import workspace
...
def test_existing_campaign_transitions_without_new_lineage_or_iteration(initial, change):
    from tests.legacy.test_context_transition import request, journal
...
def published_clone(initial, tmp_path):
    from tests.legacy.test_results_resume import clone
    from tests.legacy.test_weight_dependency import candidate
