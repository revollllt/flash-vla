...
Candidate extension (not accepted): fuse the original FP32 AdaRMS formula with the existing Pi0/Pi0.5 torch.compile pattern, preserving engine-local modulation caches. Earlier BF16 factor storage is not reused. Isolated real-weight probe611019 (75 allocated GPU seconds) measures720 norm calls: A/B/A21.646336/1.239232/21.644352 ms, conservative20.405120 ms saving, spread0.001984 ms. Max relative RMS0.000157023, max absolute0.0625 over synthetic hidden states; not bitwise equivalent and not an E2E claim. Compile cost16.58 s. Full-model correctness and same-job timing against c516eb2 remain required before accepting lab/plans/lingbot-fused-norm.json. Reject on correctness failure or insignificant paired gain; other model kernels may hide isolated savings. No portable derived tables are introduced.
