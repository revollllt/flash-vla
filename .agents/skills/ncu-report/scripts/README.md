...
```bash
python .agents/skills/ncu-report/scripts/report_query.py summary artifacts/profile/kernel.ncu-rep
python .agents/skills/ncu-report/scripts/report_query.py hotspots artifacts/profile/kernel.ncu-rep --top 10
python .agents/skills/ncu-report/scripts/analyze_reports.py \
...
cp .agents/skills/ncu-report/scripts/harness_template.cu artifacts/profile/harness/kernel.cu
cp .agents/skills/ncu-report/scripts/safetensors_loader.h artifacts/profile/harness/
