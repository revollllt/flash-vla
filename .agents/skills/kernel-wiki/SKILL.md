...
```bash
python .agents/skills/kernel-wiki/scripts/query.py --symptom fusion-regression --compact
python .agents/skills/kernel-wiki/scripts/get_page.py technique-release-on-retirement
```
